...
import { ShieldCheck, MessageCircle, Gavel, BookOpen, Menu, X, LogIn, LogOut, Rocket, Loader2 } from 'lucide-react'; // Added Rocket, Loader2
...
const navItems = [
  ...
  { href: '/guide', label: 'Site Guide', icon: Rocket }, // Added Site Guide
];
