...
import { MessageCircle, Gavel, BookOpen, Menu, LogIn, LogOut, Rocket, Loader2, UserCog, Home } from 'lucide-react';
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 flex-shrink-0">
      <div className="container mx-auto flex h-16 items-center justify-between px-4">
        <Link
          href="/"
          className="group flex items-center gap-2 mr-6"
        >
          <Image
            src="/logo.png"
            alt="CyberMozhi Logo"
          ...
          />
           <span className="font-bold text-xl text-primary font-headline hidden sm:inline-block">CyberMozhi</span>
        </Link>
                     ...
                     <Link
                      ...
                      >
                       <Image
                          ...
                          className="transition-transform duration-300 ease-in-out group-hover:scale-105 rounded-full"
                        />
                        <span className="font-bold text-lg text-primary font-headline">CyberMozhi</span>
                    </Link>
                  </SheetHeader>
